...
class MountainAdventure:
    ...
    def dragon_fight(self):
        if self.adventure.already_visited() is False:
            print("There is a Mountain Dragon in the camp, Hurry)
            time.sleep(2)
            print("")
            ...
            print("The wind blows steadily from the mountains to the East)
    ...
    def golem_fight(self):
        if self.adventure.already_visited() is False:
            ...
            print("Oh hey look it's that golem again! I really hope it's dead)
            print("I think we got everything, so to be safe)
    ...
    def maliciousMountainLion_fight(self):
        if self.adventure.already_visited() is False:
            ...
            print("Look, it's that mountain lion that bit me! I think we should leave)
            print("This place is clean)