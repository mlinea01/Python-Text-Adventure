...
class Punch(Attack):
    def __init__(self):
        ...
        super().__init__(name, desc, damage=1, atkType=AttackTypes.Normal, target=TargetTypes.Enemy_Single, manaCost=0)
...
class Block(Attack):
    def __init__(self):
        ...
        super().__init__(name, desc, damage=0, atkType=AttackTypes.Normal, target=TargetTypes.Self, manaCost=0)
