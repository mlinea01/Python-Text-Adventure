...
class rock_throw(Attack):
    def __init__(self):
        ...
        super().__init__("Rock Throw", desc, damage=7, atkType=AttackTypes.Earth, statusEffects=Stun(1),
...
class rock_slide(Attack):
    def __init__(self):
        ...
        super().__init__("Rock Slide", desc, damage=7, atkType=AttackTypes.Earth, statusEffects=Blind(1),
                         target=TargetTypes.Enemy_Single, manaCost=1)
...
class Scorch(Attack):
    def __init__(self):
        ...
        super().__init__("Scorch", desc, damage=7, atkType=AttackTypes.Fire, statusEffects=Stun(1),
                         target=TargetTypes.Enemy_Single, manaCost=1)
...
class fire_breathe(Attack):
    def __init__(self):
        ...
        super().__init__("Fire Breathe", desc, damage=7, atkType=AttackTypes.Fire, statusEffects=Blind(1),
                         target=TargetTypes.Enemy_Single, manaCost=1)
...
class whirl_pool(Attack):
    def __init__(self):
        ...
        super().__init__("Whirl Pool", desc, damage=7, atkType=AttackTypes.Water, statusEffects=Stun(1),
                         target=TargetTypes.Enemy_Single, manaCost=1)
...
class Mist(Attack):
    def __init__(self):
        ...
        super().__init__("Mist", desc, damage=7, atkType=AttackTypes.Water, statusEffects=Blind(1),
                         target=TargetTypes.Enemy_Single, manaCost=1)
